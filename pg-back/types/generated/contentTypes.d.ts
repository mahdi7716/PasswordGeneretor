...
export interface ApiPasswordSettingPasswordSetting
  extends Struct.CollectionTypeSchema {
  collectionName: 'password_settings';
  info: {
    description: '';
    displayName: 'PasswordSetting';
    pluralName: 'password-settings';
    singularName: 'password-setting';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::password-setting.password-setting'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    useLowercase: Schema.Attribute.Boolean;
    useNumbers: Schema.Attribute.Boolean;
    useSymbols: Schema.Attribute.Boolean;
    useUppercase: Schema.Attribute.Boolean;
  };
}
...
export interface ApiPasswordPassword extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Strength: Schema.Attribute.Enumeration<
      [
        '\u0642\u0648\u06CC ',
        '\u0645\u062A\u0648\u0633\u0637 ',
        '\u0636\u0639\u06CC\u0641',
...
export interface ApiQrCodeQrCode extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    password: Schema.Attribute.Relation<'oneToOne', 'api::password.password'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiStatStat extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    generatedCount: Schema.Attribute.Integer;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::password-setting.password-setting': ApiPasswordSettingPasswordSetting;
